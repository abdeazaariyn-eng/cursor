  ...
  return (
    <section className="py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <h1 className="text-3xl font-bold text-[#142B3B] mb-8">سياسة الخصوصية</h1>
        ...
        <div className="flex flex-col gap-8 text-[#142B3B]">
          ...
          <div>
            ...
            <p className="text-[#506A77] leading-relaxed">
              ...
              <a href="mailto:support@mahdbaby.shop" className="text-[#4A8B9A] underline">
                support@mahdbaby.shop
              </a>
            </p>
          </div>

          <p className="text-[#6B8A99] text-sm">
            آخر تحديث: مايو 2026
          </p>
        </div>
      </div>
